...
export type GetProductByIdQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, name: string, slug: string, description: string, featuredAsset?: { __typename?: 'Asset', preview: string } | null, assets: Array<{ __typename?: 'Asset', preview: string }>, variants: Array<{ __typename?: 'ProductVariant', id: string, name: string, price: number, priceWithTax: number, currencyCode: CurrencyCode, stockLevel: string, sku: string, options: Array<{ __typename?: 'ProductOption', id: string, name: string, code: string, group: { __typename?: 'ProductOptionGroup', id: string, name: string, code: string } }>, featuredAsset?: { __typename?: 'Asset', preview: string } | null }>, facetValues: Array<{ __typename?: 'FacetValue', id: string, name: string, code: string, facet: { __typename?: 'Facet', id: string, name: string, code: string } }>, collections: Array<{ __typename?: 'Collection', id: string, name: string, slug: string, breadcrumbs: Array<{ __typename?: 'CollectionBreadcrumb', id: string, name: string, slug: string }> }> } | null };
